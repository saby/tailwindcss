...
module.exports = {
    ...
    corePlugins: {
        ...
        backdropBlur: true, // Utilities for applying backdrop blur filters to an element
        blur: true, // Utilities for applying blur filters to an element
        ...
        lineClamp: true, // Utilities for clamping text to a specific number of lines
        ...
        translate: true, // Utilities for translating elements with transform
